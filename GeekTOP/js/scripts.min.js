...
$(function () {
	...
	$('.mainHeader__searchWrap').click(function (e) {
		e.stopPropagation();
	});

	// mobile menu

	$('.mainHeader').after('<div class="mobileMenu d-lg-none">');
	$('.mainHeader__menu').clone().appendTo('.mobileMenu');
	$('.mainHeader__mobileMenuButton').click(function () {
	...
	$('.mainHeader__mobileMenuButton').click(function (i) {
		i.stopPropagation();
	});
	...
	$('.colItem').hover(function () {
		ths = $(this);
		lnk = ths.closest('.colItem').find('h4 a');
		lnk.addClass('hover');
	}, function () {
	...
	$('.typeOneSection__imageLink').hover(function () {
		ths = $(this);
		lnk = ths.closest('.typeOneSection__leftItem').find('h3 a');
		lnk.addClass('hover');
	}, function () {
		lnk.removeClass('hover');
	});
